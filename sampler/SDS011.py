#!/usr/bin/python
'''
Nova SDS011 sensor reader class
A Python script that parses SDS011 sensor data
...
"""SDS011 Air Partuclate Densiry Sensor."""
import struct
import serial
...
class SDS011(object):
    ...
    def __init__(self, serial_port, baudrate=9600, timeout=2,
        ...
        self.ser = serial.Serial(port=serial_port,
                                 baudrate=baudrate, stopbits=serial.STOPBITS_ONE,
